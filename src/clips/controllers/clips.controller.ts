...
export class ClipsController {
  ...
  @Post()
  async create(@Body() createClipDto: CreateClipDto, @Res() res: Response) {
    try {
  ...
  @Get()
  async findAll(@Res() res: Response): Promise<Clips[]> {
    try {
  ...
  @Get(':id')
  findOne(@Param('id') _id: string, @Res() res: Response) {
    try {
  ...
  @Delete(':id')
  remove(@Param('id') _id: string, @Res() res: Response) {
    try {
